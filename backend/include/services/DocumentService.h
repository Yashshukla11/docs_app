...
public:
    ...
    static Document updateDocument(const std::string& doc_id, const std::string& user_id, const std::string& title, const std::string& content, int expected_version = -1);
